...
describe "Beerlist page" do
  ...
  it "shows beers in right order", js:true do
    visit beerlist_path
    expect(find('table').find('tr:nth-child(2)')).to have_content "Fastenbier" # Ekarivi on 2
  ...
  it "shows styles in right order", js:true do
    visit beerlist_path
    click_link "style"
    expect(find('table').find('tr:nth-child(2)')).to have_content "Lager" # Ekarivi on 2
  ...
  it "shows breweries in right order", js:true do
    visit beerlist_path
    click_link "brewery"
    expect(find('table').find('tr:nth-child(2)')).to have_content "Ayinger" # Ekarivi on 2
